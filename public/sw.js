...
const CACHE = "sideline-shell-v22";
...
self.addEventListener("fetch", (e) => {
  ...
  // Any other page (the parents' /snacks page, opened on the coach's own phone)
  // is not part of the shell: network only, or it would be served the app.
  if (e.request.mode === "navigate" && url.pathname !== "/" && url.pathname !== "/index.html") return;
